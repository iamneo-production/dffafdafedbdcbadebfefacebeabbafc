...
public class ApplSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.csrf().disable().cors().and().authorizeHttpRequests().antMatchers("/api/register","/api/auth/login","/api/admin/*","/api/organizer/*","/player/***","/player","/api/admin/teams/***","/player/***/***").permitAll()
